...
#bins = [200., 250.0, 300.0, 350.0, 400.0, 500.0, 600.0, 750, 1000.0,1250.0]
#bins_monov = [250.0, 300.0, 350.0, 400.0, 500.0, 600.0, 750, 1000.0]
...
monojet_category = {
	    'name':"monojet"
            #,'in_file_name':"/afs/cern.ch/work/z/zdemirag/work/ichep/MonoX/monojet/analysis/limits/160628/MonoJetLimitsTrees.root"
            ,'in_file_name':"/afs/cern.ch/work/z/zdemirag/work/ichep/MonoX/monojet/analysis/limits/160715/MonoJetLimitsTrees.root"
            ,"cutstring":"met>200"
	   	...
	   	{  
		  # Signal Region
                   "Zvv_ht100_lo_signal"           :['signal','zjets',1,0]
                  ,"Zvv_ht200_lo_signal"           :['signal','zjets',1,0]
                  ,"Zvv_ht400_lo_signal"           :['signal','zjets',1,0]
                  ,"Zvv_ht600_lo_signal"           :['signal','zjets',1,0]
                  ,"Zvv_ht800_lo_signal"           :['signal','zjets',1,0]
                  ,"Zvv_ht1200_lo_signal"          :['signal','zjets',1,0]
                  ,"Zvv_ht2500_lo_signal"          :['signal','zjets',1,0]
                  #,"ewk_Zll_signal"                :['signal','ewk',1,0]
                  #,"ewk_Zvv_signal"                :['signal','ewk',1,0]
                  #,"ewk_Wp_signal"                 :['signal','ewk',1,0]
                  #,"ewk_Wm_signal"                 :['signal','ewk',1,0]
                  ...
                  ,"Wlv_ht250_signal"              :['signal','wjets',1,0]
                  ...
                  ,"QCD_1500To2000_signal"         :['signal','qcd',1,0]
                  ,"QCD_2000ToInf_signal"          :['signal','qcd',1,0]
                  ...
                  #,"ewk_Zll_Zmm"                :['Zmm','ewk',1,0]
                  #,"ewk_Zvv_Zmm"                :['Zmm','ewk',1,0]
                  #,"ewk_Wp_Zmm"                 :['Zmm','ewk',1,0]
                  #,"ewk_Wm_Zmm"                 :['Zmm','ewk',1,0]  
                  ...
                  #,"ewk_Zll_Zee"                :['Zee','ewk',1,0]
                  #,"ewk_Zvv_Zee"                :['Zee','ewk',1,0]
                  #,"ewk_Wp_Zee"                 :['Zee','ewk',1,0]
                  #,"ewk_Wm_Zee"                 :['Zee','ewk',1,0]  
                  ...
                  ,"Wlv_ht250_Wmn"              :['Wmn','wjets',1,1]
                  ,"Wlv_ht400_Wmn"              :['Wmn','wjets',1,1]
                  ,"Wlv_ht600_Wmn"              :['Wmn','wjets',1,1]
                  #,"ewk_Zll_Wmn"                :['Wmn','ewk',1,0]
                  #,"ewk_Zvv_Wmn"                :['Wmn','ewk',1,0]
                  #,"ewk_Wp_Wmn"                 :['Wmn','ewk',1,0]
                  #,"ewk_Wm_Wmn"                 :['Wmn','ewk',1,0]  
                  ...
                  ,"QCD_1500To2000_Wmn"         :['Wmn','qcd',1,0]
                  ,"QCD_2000ToInf_Wmn"          :['Wmn','qcd',1,0]
                  ...
                  ,"Wlv_ht250_Wen"              :['Wen','wjets',1,1]
                  ,"Wlv_ht400_Wen"              :['Wen','wjets',1,1]
                  ,"Wlv_ht600_Wen"              :['Wen','wjets',1,1]
                  #,"ewk_Zll_Wen"                :['Wen','ewk',1,0]
                  #,"ewk_Zvv_Wen"                :['Wen','ewk',1,0]
                  #,"ewk_Wp_Wen"                 :['Wen','ewk',1,0]
                  #,"ewk_Wm_Wen"                 :['Wen','ewk',1,0]  
                  ...
                  ,"QCD_1500To2000_Wen"         :['Wen','qcd',1,0]
                  ,"QCD_2000ToInf_Wen"          :['Wen','qcd',1,0]
                  ...
                  ,"QCD_1500To2000_gjets"        :['gjets','qcd',1,0]
                  ,"QCD_2000ToInf_gjets"         :['gjets','qcd',1,0]
...
monov_category = {
	    'name':"monov"
            #,'in_file_name':"/afs/cern.ch/work/z/zdemirag/work/ichep/MonoX/monojet/analysis/limits/160628/MonoVLimitsTrees.root"
            ,'in_file_name':"/afs/cern.ch/work/z/zdemirag/work/ichep/MonoX/monojet/analysis/limits/160715/MonoVLimitsTrees.root"
            ,"cutstring":"met>250"
