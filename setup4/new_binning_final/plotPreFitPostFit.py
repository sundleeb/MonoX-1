...
def plotPreFitPostFit(region):
  ...
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/unblinding/new_bin_prefit_postfit_"+region+".pdf")
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/unblinding/new_bin_prefit_postfit_"+region+".png")
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/unblinding/new_bin_prefit_postfit_"+region+".C")
